...
function focusPlusContext(data) {
    ...
    */
    ...
    focus.append("g")
    //here..
        .attr("class", "axis axis--x") // make a css class for potetial styling
        .attr("transform", "translate(0," + height + ")") // pushes down the x-axis to the bottom
        .call(xAxis); // draw the line
    focus.append("g")
    //here..
    ...
    context.append("g")
        .attr("class", "brush")
        .call(brush)
        .call(brush.move, navXScale.range());
